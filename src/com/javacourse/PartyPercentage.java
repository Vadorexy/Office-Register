...
public class PartyPercentage {
    public static void main(String[] args) {
        ...
        System.out.println(percent_party1+ " % of the vote party "+party1+ " received");
        System.out.println(percent_party2+ " % of the vote party "+party2+ " received");
        System.out.println(percent_party3+ " % of the vote party "+party3+ " received");
